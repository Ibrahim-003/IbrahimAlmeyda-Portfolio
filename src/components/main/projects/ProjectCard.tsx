...
const ProjectCard: React.FC<MappedRepo> = ({
  ...
  return (
    <article className="w-full max-w-[350px] mx-auto px-3 py-6 bg-light-cream dark:bg-white/10 rounded-lg shadow-xl flex flex-col justify-between gap-5 sm:px-4 md:max-w-[400px]">
