import { FaHtml5, FaCss3Alt, FaReact, FaGithub, FaExternalLinkAlt } from "react-icons/fa";
  ...
  return (
    <footer>
      ...
      <div className="flex items-center justify-end gap-3 px-2">
        ...
        <FaExternalLinkAlt className="text-2xl text-teal-primary transform transition-transform duration-300 hover:scale-125" />
        </a>
      </div>
    </footer>
  );
